...
export default function Country() {
  ...
  const { data: country, isLoading, error } = useFetch(url)
        ...
        {country && (
          <div key={country.name}>
            ...
            <div className="countryInfo countryWrapper">
              ...
              <p className="countryData">Native name : {country.nativeName}</p>
              <p className="countryData">Capital : {country.capital}</p>
              <p className="countryData">
                Alt spellings : {country.altSpellings}
              </p>
              <p className="countryData">Population : {country.population}</p>
              ...
              <p className="countryData">Numeric Code :{country.numericCode}</p>
              <div className="countryData">
                <p>Languages </p>
